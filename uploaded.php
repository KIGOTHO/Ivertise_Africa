...
<?php
		$link = mysql_connect("localhost", "mjedevel_kev", "Token2016");
				...
				$image_author = mysql_real_escape_string($_POST['author'],$link);
...
// close connection
	...
	?>
	    <ul>
         <li>Sent file: <?php echo $_FILES['image_file']['name'];  ?>
         <li>File size: <?php echo $_FILES['image_file']['size'];  ?>
         <li>File type: <?php echo $_FILES['image_file']['type'] ?>
      </ul>
      <ul>
           <li><a href="users/dashboard.php">Back To Dashboard</a></li>
      </ul>
